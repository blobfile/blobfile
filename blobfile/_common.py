...
#    StreamingReadFile(ctx, path: str)
#    StreamingWriteFile(ctx, path: str)
# TODO: make all backends inherit from this plus the above two classes
# class Backend(ABC):
#    @staticmethod
#    @abstractmethod
#    def maybe_stat(ctx, path: str) -> Optional[Stat]:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def remove(ctx, path: str) -> bool:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def maybe_update_md5(ctx, path: str, generation: str, hexdigest: str) -> bool:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def list_blobs(
#        ctx, path: str, delimiter: Optional[str] = None
#    ) -> Iterator[DirEntry]:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def get_url(ctx, path: str) -> Tuple[str, Optional[float]]:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def join_paths(ctx, a: str, b: str) -> str:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def isdir(ctx, path: str) -> bool:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def mkdirfile(ctx, path: str) -> None:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def set_mtime(ctx, path: str, mtime: float, version: Optional[str] = None) -> bool:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def split_root(ctx, path: str) -> Tuple[str, str]:
#        """(used in glob and rmdir and basename)"""
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def dirname(ctx, path: str) -> str:
#        pass
#
#    @staticmethod
#    @abstractmethod
#    def parallel_upload(
#        executor: Executor, src: str, dst: str, return_md5: bool
#    ) -> Optional[str]:
#        pass
#
#    @staticmethod
