...
def exists(path: str) -> bool:
    ...
    """
    return _context.exists(path=path)
...
def basename(path: str) -> str:
    ...
    """
    return _context.basename(path=path)
...
def glob(pattern: str, parallel: bool = False) -> Iterator[str]:
    ...
    """
    return _context.glob(pattern=pattern, parallel=parallel)
...
def scanglob(pattern: str, parallel: bool = False) -> Iterator[DirEntry]:
    ...
    """
    return _context.scanglob(pattern=pattern, parallel=parallel)
...
def isdir(path: str) -> bool:
    ...
    """
    return _context.isdir(path=path)
...
def listdir(path: str, shard_prefix_length: int = 0) -> Iterator[str]:
    ...
    """
    return _context.listdir(path=path, shard_prefix_length=shard_prefix_length)
...
def scandir(path: str, shard_prefix_length: int = 0) -> Iterator[DirEntry]:
    ...
    """
    return _context.scandir(path=path, shard_prefix_length=shard_prefix_length)
...
def makedirs(path: str) -> None:
    ...
    """
    return _context.makedirs(path=path)
...
def remove(path: str) -> None:
    ...
    """
    return _context.remove(path=path)
...
def rmdir(path: str) -> None:
    ...
    """
    return _context.rmdir(path=path)
...
def stat(path: str) -> Stat:
    ...
    """
    return _context.stat(path=path)
...
def set_mtime(path: str, mtime: float, version: Optional[str] = None) -> bool:
    ...
    version matches
    """
    return _context.set_mtime(path=path, mtime=mtime, version=version)
...
def rmtree(path: str) -> None:
    ...
    """
    return _context.rmtree(path=path)
...
def walk(
    ...
    """
    return _context.walk(top=top, topdown=topdown, onerror=onerror)
...
def dirname(path: str) -> str:
    ...
    """
    return _context.dirname(path=path)
...
def get_url(path: str) -> Tuple[str, Optional[float]]:
    ...
    """
    return _context.get_url(path=path)
