...
def configure(
    *,
    ...
    eagerly_get_size: bool = DEFAULT_EAGERLY_GET_SIZE,
    ...
    eagerly_get_size: if set to `True`, retrieve the size of Azure files when opening them
    ...
    default_context = create_context(
        ...
        eagerly_get_size=eagerly_get_size,
